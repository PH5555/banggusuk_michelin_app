...
const GroupPresenter = ({navigateTo}) => {
	return (
		<Style.Container>
			...
			<Button onClick={()=>navigateTo('./create')} backgroundColor={'#FF4F26'} color={'#ffffff'}>그룹 만들기</Button>
			<Style.Box/>
			<Button onClick={()=>navigateTo('./join')} backgroundColor={'#ffffff'} color={'#FF4F26'} shadow={true}>그룹에 가입하기</Button>
		</Style.Container>
	)
}
